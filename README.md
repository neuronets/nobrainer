...
Please refer to the Jupyter notebooks in the [guide](https://github.com/neuronets/nobrainer-book/blob/ohinds-guide-api/docs/nobrainer-guides) directory to get
