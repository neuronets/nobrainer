...
class Generator:
    ...
    '''
    def __init__(self, latent_size, label_size=0, num_channels=1, fmap_base=8192, fmap_max=256, dimensionality=3, name='generator'):
    ...
    def add_resolution(self):
        '''
        Adds a resolution step to the trainable generator by creating a generator block and appending
        on top of the existing generator to increase the resolution of the images generated by a factor of 2.
...
class Discriminator:
    ...
    def __init__(self, label_size=0, num_channels=1, fmap_base=8192, fmap_max=512, dimensionality=3, name='discriminator'):
    ...
    def add_resolution(self):
        ...
        self.train_discriminator = models.Model(inputs=[inputs, alpha], outputs=[score_output, label_output], name=self.name)
