...
class Discriminator(tf.keras.Model):
    ...
    def add_resolution(self):
        '''
        Adds a resolution step to the trainable discriminator by creating a discriminator block and inserting
        at the start of the existing discriminator to increase the resolution of the images discimrinated by a factor of 2.
