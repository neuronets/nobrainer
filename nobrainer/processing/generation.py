...
class Generation(BaseEstimator):
    ...
    def fit(
        ...
        if g_optimizer is None:
            ...
            g_opt_args_tmp = dict(learning_rate=1e-04, beta_1=0.0, beta_2=0.99, epsilon=1e-8)
        ...
        if d_optimizer is None:
            ...
            d_opt_args_tmp = dict(learning_rate=1e-04, beta_1=0.0, beta_2=0.99, epsilon=1e-8)
        ...
        for resolution in self.resolutions_:
            ...
            self.generator_.save(str(model_dir.joinpath('generator_res_{}'.format(resolution))))
            
        return self

    def generate(self, x, latent_size=1024,):
